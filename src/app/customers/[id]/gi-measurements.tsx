...
export default function GiMeasurementsScreen() {
  ...
  return <GiMeasurementsScreenContent customer={customer} />;
}

function GiMeasurementsScreenContent({ customer }: { customer: CustomerRecord }) {
  const { content, footer } = useGiMeasurementsPanel(customer);
